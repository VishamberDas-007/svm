...
customerRouter.patch('/upload/aadhar-image/:customerId', (0, auth_middleware_1.authMiddleware)(['CUSTOMER_WRITE']), s3_1.upload.fields([{ name: 'aadharImages', maxCount: 2 }]), customerController.uploadAadharImage);
